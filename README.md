...
- [ ] silent loading
- [ ] collapse
- [ ] separate authorization as Auth0 SDK


Below is the text generated by [yew-trunk-minimal-template](https://github.com/yewstack/yew-trunk-minimal-template).
...
There are two empty spaces in the MIT license you need to fill out: `` and `emergent <yosikawa@gmail.com>`.
